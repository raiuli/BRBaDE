function [bestmem,bestval,nfeval] = BRBADEv3(fname,VTR,D,XVmin,XVmax,y,NP,itermax,F,CR,strategy,refresh)
...
%         ffc=FC*10^n;
        ...
        if iter==2
            fprintf(fid_x1,"\nPC,FC,d11,d12,d21,d22,F,CR");
        end    
        %fprintf(fid_x1,"\nPC:%g,FC:%g,d11:%g,d12:%g,d21:%g,d22:%g",PC,FC,d11,d12,d21,d22);
        fprintf(fid_x1,"\n%g,%g,%g,%g,%g,%g",PC,FC,d11,d12,d21,d22);
        %if PC==0 || FC==0

function [bestmem,bestval,nfeval] = BRBADEcustomeRWAW(fname,VTR,D,XVmin,XVmax,y,NP,itermax,F,CR,strategy,refresh)
...
while ((iter < itermax) & (bestval > VTR))
    ...
    parfor i=1:NP                      % population filled with the best member

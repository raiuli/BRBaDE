function [bestmem,bestval,nfeval] = FADE(fname,VTR,D,XVmin,XVmax,y,NP,itermax,F,CR,strategy,refresh)
...
s = strcat('Log/FADE',dateString,'.txt');
fid_x1 = fopen (s, 'w');
s = strcat('Log/FADE_bestvalue_',dateString,'.txt');
fid_x2 = fopen (s, 'w');
...
%while ((iter < itermax))
  ...
  if (iter>1) 
       ...
       d21=2*d11;
       d22=2*d12;
       fprintf(fid_x1,"\nPC:%4.2f,FC:%4.2f,d11:%4.2f,d12:%4.2f,d21:%4.2f,d22:%4.2f",PC,FC,d11,d12,d21,d22);
      
      [F,CR]=FLCS(d11,d12, d21,d22);
       fprintf(fid_x1,",F:%4.2f,CR:%4.2f,",F,CR);
       data(iter,1)=PC;
     data(iter,2)=FC;
     data(iter,3)=d11;
     data(iter,4)=d12;
...
ss=sprintf('%s_fade.mat',fname)
delete(ss)
save(ss,'data')
ss=sprintf('%s_fade_his.mat',fname)
delete(ss)

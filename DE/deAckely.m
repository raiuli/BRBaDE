function [bestmem,bestval,nfeval] = deAckely(fname,VTR,D,XVmin,XVmax,y,NP,itermax,F,CR,strategy,refresh);
...
for i=1:NP
   ...
   plot3(pop(i,1),pop(i,2),0,'.r','markersize',10)
end
...
% for i=1:NP
%     figure(2)
%    plot3(ui(i,1),ui(i,2),0,'.b','markersize',10);
% end
...
%----Output section----------------------------------------------------------
  ...
  if (refresh > 0)
    if (rem(iter,refresh) == 0)
       ...
       for i=1:NP
            figure(2)
            plot3(pop(i,1),pop(i,2),0,'.k','markersize',10);
       end
        ...
        plot3(bestmem(1,1),bestmem(1,2),0,'dk','markersize',10);
         ...
         figure(1)
        plot3(bestmem(1,1),bestmem(1,2),bestval,'dk','markersize',10);
    end
  end
